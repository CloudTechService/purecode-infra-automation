# live/iha-account-root/account.hcl
# Account-specific configuration for iha-account-root environment
...
locals {
  ...
  stop_schedule  = "cron(15 19 ? * MON-FRI *)"   # 7:15 PM UTC Mon-Fri (1 AM NPT next day)y
