# live/purecode/us-east-2/QA-server-schedular/terragrunt.hcl
...
locals {
  ...
  start_enabled = false   # Set to false to disable start schedule
  stop_enabled  = true  # Set to false to disable stop schedule
...
inputs = {
  ...
  stop_schedule      = "cron(15 14 ? * MON-FRI *)"  # 7:15 PM UTC
